...
image bg_village_path_night = Transform("images/bg/bg_village_path_night.png", xysize=(1920, 1080))
...
image bg_village_path_day = Transform("images/bg/bg_village_path_day.png", xysize=(1920, 1080))
...
image bg_adv_chapter_card_prologue = Transform("images/bg/bg_adv_chapter_card_prologue.png", xysize=(1920, 1080))
image bg_adv_chapter_card_ch1 = Transform("images/bg/bg_adv_chapter_card_ch1.png", xysize=(1920, 1080))
image bg_adv_chapter_card_ch2 = Transform("images/bg/bg_adv_chapter_card_ch2.png", xysize=(1920, 1080))
image bg_adv_chapter_card_ch3 = Transform("images/bg/bg_adv_chapter_card_ch3.png", xysize=(1920, 1080))
image bg_adv_chapter_card_ch4 = Transform("images/bg/bg_adv_chapter_card_ch4.png", xysize=(1920, 1080))
image bg_adv_chapter_card_ch5 = Transform("images/bg/bg_adv_chapter_card_ch5.png", xysize=(1920, 1080))
image bg_adv_restaurant = Transform("images/bg/bg_adv_restaurant.png", xysize=(1920, 1080))
image bg_adv_village_gate = Transform("images/bg/bg_adv_village_gate.png", xysize=(1920, 1080))
image bg_adv_mak_ros_house = Transform("images/bg/bg_adv_mak_ros_house.png", xysize=(1920, 1080))
image bg_adv_grave_inspect = Transform("images/bg/bg_adv_grave_inspect.png", xysize=(1920, 1080))
image bg_adv_old_house = Transform("images/bg/bg_adv_old_house.png", xysize=(1920, 1080))
image bg_adv_old_house_azlan_paper = Transform("images/bg/bg_old_house_azlan_paper.png", xysize=(1920, 1080))
image bg_adv_preparation = Transform("images/bg/bg_adv_preparation.png", xysize=(1920, 1080))
image bg_adv_final_grave = Transform("images/bg/bg_adv_final_grave.png", xysize=(1920, 1080))
image bg_ending_released = Transform("images/bg/DILEPASKAN.png", xysize=(1920, 1080))
image bg_ending_abandoned = Transform("images/bg/DITINGGALKAN.png", xysize=(1920, 1080))
image bg_ending_buried = Transform("images/bg/TERKUBUR BERSAMA.png", xysize=(1920, 1080))
image bg_ending_ignorance = Transform("images/bg/TIDAK_FAHAM.png", xysize=(1920, 1080))
...
image spr_hafiz neutral = Transform("images/characters/hafiz/hafiz_neutral.png", zoom=0.44)
